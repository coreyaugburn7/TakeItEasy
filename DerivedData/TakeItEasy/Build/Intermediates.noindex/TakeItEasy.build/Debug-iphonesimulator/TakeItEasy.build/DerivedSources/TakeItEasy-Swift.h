...
#ifndef TAKEITEASY_SWIFT_H
#define TAKEITEASY_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="TakeItEasy",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10TakeItEasy11AppDelegate")
...
@interface Journal (SWIFT_EXTENSION(TakeItEasy))
...
SWIFT_CLASS("_TtC10TakeItEasy11NoteContent")
@interface NoteContent : UIViewController
...
SWIFT_CLASS("_TtC10TakeItEasy14NoteController")
@interface NoteController : UIViewController <UITableViewDataSource, UITableViewDelegate>
@property (nonatomic, weak) IBOutlet UITableView * _Null_unspecified tv;
...
SWIFT_CLASS("_TtC10TakeItEasy13SceneDelegate")
...
SWIFT_CLASS("_TtC10TakeItEasy14ViewController")
